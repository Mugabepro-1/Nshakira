...
import itemsService, { FoundItemData } from '../../services/itemsService';
...
const ItemSchema = Yup.object().shape({
  ...
  foundDate: Yup.date()
    ...
    .max(new Date(), 'Found date cannot be in the future'),
...
const ReportFoundItem = () => {
  ...
  const handleSubmit = async (values: FoundItemData) => {
    setLoading(true);
    try {
      await itemsService.reportFoundItem(values);
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Report Found Item</h1>
        <p className="mt-1 text-gray-600">
          Help someone find their lost item by reporting what you've found.
        </p>
      </div>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                >
                  <Field
                    ...
                    className={`appearance-none block w-full px-3 py-2 border ${
                      errors.foundDate && touched.foundDate
                        ? 'border-error-300 focus:border-error-500 focus:ring-error-500'
                        : 'border-gray-300 focus:border-primary-500 focus:ring-primary-500'
                    } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-1 sm:text-sm`}
                  />
